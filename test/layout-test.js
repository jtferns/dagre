...
describe("layout", function () {
  ...
  it("can layout subgraphs with different rankdirs", function () {
    ...
    function check(rankdir) {
      expect(g.node("sg").width, "width " + rankdir).gt(19);
      expect(g.node("sg").height, "height " + rankdir).gt(19);
      expect(g.node("sg").x, "x " + rankdir).gt(19 / 2);
      expect(g.node("sg").y, "y " + rankdir).gt(19 / 2);
    }
